...
![Captura de pantalla - Projects - Add item](images/project-add-item-text.gif)
...
![Captura de pantalla - Projects - Add item from Issues and Pull Requests](images/project-add-item-issues-pr.gif)
